...
row = 0
df1 = pd.DataFrame({'브랜드':[], '제품명':[], '현재 판매가':[], '회원 판매가':[], '옵션':[], '상세정보':[], 'url':[]})
for url in link_list :
    ...
    df1.loc[row] = [brand, title, prod_sale_price, prod_coupon_price, prod_option_item, prod_description, url]
    row += 1

    print()

df1.to_excel(excel_writer='C:/Users/go_he/OneDrive/바탕 화면/PythonWork/07.coupang_excel.xlsx')
